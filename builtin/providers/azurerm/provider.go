...
func Provider() terraform.ResourceProvider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"azurerm_custom_script_extension_domain":  resourceArmCustomScriptExtensionDomain(),
			"azurerm_custom_script_extension_linux":   resourceArmCustomScriptExtensionLinux(),
			"azurerm_custom_script_extension_windows": resourceArmCustomScriptExtensionWindows(),
			"azurerm_custom_script_extension_wmf":     resourceArmCustomScriptExtensionWmf(),
