...
func resourceArmCustomScriptExtensionWindows() *schema.Resource {
	return &schema.Resource{
		Create: resourceArmCustomScriptExtensionWindowsCreateOrUpdate,
		Read:   resourceArmCustomScriptExtensionWindowsRead,
		Update: resourceArmCustomScriptExtensionWindowsCreateOrUpdate,
...
func resourceArmCustomScriptExtensionWindowsCreateOrUpdate(d *schema.ResourceData, meta interface{}) error {
...
func resourceArmCustomScriptExtensionWindowsRead(d *schema.ResourceData, meta interface{}) error {
